        ...
        val dpd = DatePickerDialog(
            this, { _, Selectedyear, Selectedmonth, SelecteddayofMonth ->
                ...
                val mytoast = Toast.makeText(
                    ...
                    Toast.LENGTH_LONG,)
                mytoast.getView()
                    ?.setBackgroundColor((Color.parseColor("#80ed99")));mytoast.show()//It count month from 0 so we added 1 and made it
                ...
                thedate?.let {
                    ...
                    currentdate?.let {  //it will run code only when date is not empty
                        ...
                        tvageinminutes?.text =
                            ("Hrs: $differenceinHrs hrs/ Minutes: $differenceInminutes min").toString()
